...
/******************************************************************************
Function   : Ringbuffer
Description: a ringbuffer of lock free.
Input      : T : Type of elements
             buffer_size : Size of the buffer. Must be a power of 2.
             wmo_multi_core :  Generate extra memory barrier instructions in case of core to core communication
             cacheline_size : Size of the cache line, to insert appropriate padding in between indexes and buffer
             index_t : Type of array indexing type. Serves also as placeholder for future implementations.
Output     : none
Return     : none
******************************************************************************/
